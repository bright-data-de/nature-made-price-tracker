...
Info  : https://brightdata.de/products/insights/price-tracker/nature-made
"""
...
# https://brightdata.de/products/web-scraper/nature-made
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Nature Made scraper at: https://brightdata.de/products/web-scraper/nature-made\n"
